...
export default function Hero() {
  return (
    ...
    />
    {/* Contenido central */}
    <div className="hero-content text-center px-4 py-8">
      <h1 className="text-3xl md:text-6xl lg:text-7xl font-bold leading-tight mb-4">
        WELCOME PET NOW
      </h1>
      ...
      <div className="absolute bottom-20 left-1/2 transform -translate-x-1/2 flex space-x-4 z-10">
        <a href="#" className="bg-amber-50 text-amber-500 rounded-full p-3 hover:bg-amber-500 hover:text-amber-50">
